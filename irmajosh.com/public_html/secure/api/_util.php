...
if (PHP_SESSION_ACTIVE !== session_status()) {
  ...
  $params = [
    // Extend session lifetime to 30 days so returning users stay logged in
...
function cfg() {
    ...
    'google' => [
      // Updated Google OAuth Client ID (2025-09-10)
      'client_id' => '301304738390-svfnm48gtb29tdbc14o0tv2003sn5eao.apps.googleusercontent.com'
    ],
        'auth' => [
