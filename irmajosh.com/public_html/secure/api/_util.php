...
// the sign-in flow.  Some hosting providers send a default
// `Cross-Origin-Opener-Policy: same-origin-allow-popups` header which
// prevents this communication and surfaces "policy would block the
// window.postMessage call" errors in the console.  Override the header here
// so that the site opts out of COOP and the Google sign-in flow can
// complete normally.
