// neutral stub main.js while UI rebuild proceeds
console.log('[secure] main.js stub loaded');
document.addEventListener('DOMContentLoaded', ()=>{ const el=document.getElementById('app'); if (el) el.textContent='Secure UI under rebuild'; });
